...
class Combination(Policy):
    ...
    def action(self, observation):
        ...
        ratio_correct_by_energy = matrix_identification_factors[:, 1] / matrix_identification_factors[:, 0]
        ...
        if self.is_first_time_seeing_message:
            ...
            identification_is_true_probabilities = np.sum(identification_is_true_probabilities ** 2)
            identification_is_false_probabilities = np.sum(identification_is_false_probabilities ** 2)
